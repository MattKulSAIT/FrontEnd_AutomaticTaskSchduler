                    ...
                    <div className='mainPage'> 
                        ...
                        <div className='taskSkillsDiv'>
                            <table align='left'>
                                ...
                                <tr>
                                    <td className='tdButton'><h3><input type='checkbox' id='network' name='network' className='skillsButton'/>Database Support</h3></td>
                                    <td className='tdButton'><h3><input type='checkbox' id='telecomm' name='telecomm' className='skillsButton'/>Database Support</h3></td>
                                </tr>
                            </table>                    
                        </div>
